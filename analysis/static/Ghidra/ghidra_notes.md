...
**Conclusión:** El binario es una simulación controlada de malware con múltiples capacidades modulares. El flujo activo ejecuta únicamente las funciones de anti-debugging y lanzamiento de `calc.exe` como payload benigno. Los módulos de persistencia, exfiltración y acceso remoto están presentes en el binario pero no invocados en la rama de ejecución analizada.
