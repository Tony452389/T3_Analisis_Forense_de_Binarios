# Disclaimer de Uso — team_sample.exe

## Propósito del Binario

El archivo **team_sample.exe** ha sido desarrollado exclusivamente con fines educativos como parte del proyecto académico **T3_Analisis_Forense_de_Binarios**.
...
Antes de ejecutar el archivo **team_sample.exe**, asegúrese de:
